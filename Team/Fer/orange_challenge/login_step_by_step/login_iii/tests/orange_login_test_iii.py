from Team.Fer.orange_challenge.login_step_by_step.login_iii.framework.common_iii import TinyCore
from Team.Fer.orange_challenge.login_step_by_step.login_iii.pages.login_page import LoginPage
