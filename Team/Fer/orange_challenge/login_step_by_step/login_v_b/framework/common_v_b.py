...
from Team.Fer.orange_challenge.login_step_by_step.login_v_b.framework.utils import Utils, Using
...
class TinyCore(Utils):
    ...
    def custom_find_element_1st_approach(self, locator_by_type, locator):
        return self.MAIN_DRIVER.find_element(locator_by_type, locator)
