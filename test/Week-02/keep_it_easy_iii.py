...
letsAutomate.do_click_by_text(AMBIGUOUS_CHROME_EXPAND_DESCRIPTION_BUTTON, "How does the DuckDuckGo app & extension "
                                                                          "work?")
# letsAutomate.do_click_from_options([EXPAND_DESCRIPTION_BUTTON, CHROME_EXPAND_DESCRIPTION_BUTTON])
