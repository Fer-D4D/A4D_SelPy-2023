...
landing_page.set_viewer_mode("OFF")

if landing_page.check_expected_text("Swag Labs"):
    print("Successful Login: Test Passed")
    print("Number of items in the shopping cart before = " + str(landing_page.check_shopping_cart()))
    landing_page.add_all_items()
    print("Number of items in the shopping cart after = " + str(landing_page.check_shopping_cart()))
